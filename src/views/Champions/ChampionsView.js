    ...
    return(
        <>
            ...
            <>
                ...
                <div key={i}  className={`flex flex-wrap text-white justify-center py-6 my-2 bg-background-lightcolor w-4/5 tall:w-2/5 tall:flex-col tall:items-center border-2 rounded-lg ${elem.kata.level === 5 ? 'border-color-5':elem.kata.level === 4 ? 'border-color-4':elem.kata.level === 3 ? 'border-color-3':elem.kata.level === 2 ? 'border-color-2':'border-color-1'}`}>

...
export default function Discussions(){
    ...
    return (
        <>
            ...
            {userdiscussion !== null||undefined ? 
                <>
                    <div className='kataComment flex flex-col items-center text-white ml-2 my-6'>
                        <p className='text-sm my-2'>My comment</p>
                        <div className='kataDiscussions border-1 rounded-lg m-4 p-4 flex flex-wrap justify-center w-11/12 flex flex-wrap justify-center'>
                                ...
                                <p className={`pt-1 m-1 ${textInput}`}>{userdiscussion.comment}</p>
                                <>  
                ...
                <>
                <p className='text-sm mb-2 pb-2 text-white '>Comments</p>
                    {discussions.sort((a,b) => a.updatedAt - b.updatedAt).reverse().map((elem,i) => {
                        return elem.user._id !== user._id  &&
                        <div key={i} className="kataDiscussions border-1 rounded-lg">

...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {user && request ? <Link to='profile/champions/request' className='championsbeat'><img src={ChampionsBeat} alt='Champions Beat' /></Link>:user && <Link to='profile/champions/new' className='championsbeat'><img src={Champions} alt='Champions Beat' /></Link>}
